...
bool bSaveImages = 1; // Saves images from the tilted camera to output folder (check filepath is right). WARNING: will produce enourmous number of images!
...
void autofocus::run () {
  ...
  int tol = 12; //Tolerance zone of pixels about the desiredLocBestFocus where no lense movement is triggered. Lower than 4 causes constant signals to lens
