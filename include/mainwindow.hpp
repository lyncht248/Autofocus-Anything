...
/**
 * @class ScaleWidget
 * @brief A custom GTK widget combining a scale and spin button for numeric input.
 * 
 * This widget allows users to input numeric values using a slider (scale) or a spin button.
 * It supports customization of precision, size, and limits.
 */
...
public:
     ...
     * 
     * Initializes the widget with specified range, increment, default value, and dimensions.
     * 
...
private:
    ...
    sigc::connection spinButtonConnection, scaleConnection; ///< Signal connections.
 ...
 * 
 * This class defines an interface for custom rendering filters that can be applied
 * to graphical contexts.
 */
class RenderFilter
{
public:
 ...
 * 
 * This class manages the main GUI elements, including buttons, sliders, and toggles.
 * It handles user interactions, updates camera values, and renders frames.
 */
